/// A generic `{id, name}` pair — used for the pricelist / agent / party /
/// other-charges dropdown options returned by `estimate.php`.
class IdName {
  final String id;
  final String name;
...
/// `List<String>`. `estimate.php` sends CSV-decrypted strings for names
